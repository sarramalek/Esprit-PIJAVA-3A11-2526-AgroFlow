...
public class AgricoleMaintenanceController implements Initializable {
    ...
    // ══════════════════════════════════════════════════════
    @FXML private void versAccueil()        { nav("/AccueilAgricole.fxml");          }
    @FXML private void handleDashboard()    { nav("/AccueilAgricole.fxml");          }
    @FXML private void handleMesTerrains()  { nav("/GestionTerrains.fxml");          }
    @FXML private void handleMesPlantes()   { nav("/agricoleplante.fxml");           }
    @FXML private void handleMesAnimaux()   { nav("/AfficherAnimaux.fxml");          }
    @FXML private void handleMesStocks()    { nav("/AfficherStocks.fxml");           }
    @FXML private void handleMonMateriel()  { nav("/AgricoleAffichageMachine.fxml"); }
    @FXML private void naviguerEvenements() { nav("/AccueilEvenement.fxml");         }
