...
import controllers.GestionAbonnements;
...
import static controllers.GestionAbonnements.dashboardBtn;
import static controllers.GestionAbonnements.showInfo;
...
public class AcceuilAgricole {
    ...
    private void handleMonAbonnement() {
        ...
        navigateTo("/MesAbonnements.fxml","Mes Abonnements");
    }
    // ── Logout ────────────────────────────────────────────────────────────────
    ...
    private void handleLogout() {
        ...
        alert.showAndWait().ifPresent(response -> {
            if (response == ButtonType.OK) {
                try {
                    FXMLLoader loader = new FXMLLoader(AcceuilAgricole.class.getResource("/login.fxml"));
