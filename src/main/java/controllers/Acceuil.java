...
public class Acceuil {
    ...
    public static void ouvrirPersonnes(MouseEvent event) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(Acceuil.class.getResource("/DahboardPersonne.fxml"));
    ...
    public static void ouvrirTaches(MouseEvent event) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(Acceuil.class.getResource("/GestionTache.fxml"));
            Parent root = loader.load();
    ...
    public static void ouvrirOffres(MouseEvent event) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(Acceuil.class.getResource("/GestionOffre.fxml"));
            Parent root = loader.load();
    ...
    public static void ouvrirAbonnements(MouseEvent event) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(Acceuil.class.getResource("/GestionAbonnements.fxml"));
            Parent root = loader.load();
